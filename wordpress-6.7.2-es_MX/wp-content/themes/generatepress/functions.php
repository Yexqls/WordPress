...
function mt_destacado_contenido($contenido){
	...
	/* El post valida que sea una publicacion y que no sea adjunto*/
...
function mt_body_class($classes){
	$indice = array_search('single-post', $classes);
		#esta clase epermite unir 2 o mas arrays
		$classes = array_merge($classes, ['otra-clase1', 'otra-clase2']);
/* 
	$classes[] = 'minuevaclase1';
	$classes[] = 'minuevaclase2'; */
